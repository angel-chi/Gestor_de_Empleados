...
public class Desarrollador {
    ...
    public String toString() {
        return "Desarrolladorño{" + "id=" + id + ", id_estudiantes=" + id_estudiantes + ", puesto=" + puesto + ", certificaciones=" + certificaciones + ", habilidades=" + habilidades + ", proyectos_en_produccion=" + proyectos_en_produccion + '}';
    }
