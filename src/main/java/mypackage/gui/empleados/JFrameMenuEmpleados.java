 ...
 * @author andre
 */
public class JFrameMenuEmpleados extends javax.swing.JFrame {

    /** Creates new form JFrameEmpleados */
    public JFrameMenuEmpleados() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("MENÚ DE EMPLEADOS");
        jDesktopPane1.add(jLabelTitulo);
        jLabelTitulo.setBounds(100, 20, 430, 42);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameMenuEmpleados.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
