...
public class JFrameVerAlumno extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jComboBoxBusquedaAlumnos.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "SELECCIONAR", "ID", "NOMBRE", "APELLIDO", "EDAD", "GÉNERO", "TIPO DE DOCUMENTO", "NÚMERO DE DOCUMENTO", "CORREO ELECTRÓNICO", "NÚMERO DE TELÉFONO", "FECHA DE INICIO", "CANTIDAD DE HS SEMANALES", "SUELDO" }));
    ...
    //Aqui eliminamos un alumno de la base de datos
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        ...
        int idEstudiante = (int) jTableListaAlumnos.getValueAt(filaTablaAlumno, 0);

        if (JOptionPane.showConfirmDialog(this, "ESTA POR ELIMINAR EL ALUMNO CON EL ID " + idEstudiante + "!!") != 0) {

            return;

        }

        alumnoRepository.remove(alumnoRepository.getById(idEstudiante));
    ...
    private void jTextFieldBusquedaEmpleadosKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBusquedaEmpleadosKeyReleased
        ...
        } else if (jComboBoxBusquedaAlumnos.getSelectedItem().equals("TIPO DE CURSO")) {

            new Table().cargar(jTableListaAlumnos, alumnoRepository.getLikeTipoCurso(jTextFieldBusquedaAlumnos.getText()));

        } else if (jComboBoxBusquedaAlumnos.getSelectedItem().equals("MATRÍCULA")) {
        ...
        } else if (jComboBoxBusquedaAlumnos.getSelectedItem().equals("EMAIL")) {

            new Table().cargar(jTableListaAlumnos, alumnoRepository.getLikeEmail(jTextFieldBusquedaAlumnos.getText()));
