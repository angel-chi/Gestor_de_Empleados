 ...
 * @author andre
 */
public class JFrameActualizarEstudiantes extends javax.swing.JFrame {

    /** Creates new form JFrameActualizarEmpleados */
    public JFrameActualizarEstudiantes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabelFecha2.setText("Inscripcion:");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFrameActualizarEstudiantes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
