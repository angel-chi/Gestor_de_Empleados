 ...
 */
package mypackage.gui.students;
...
public class JFrameAnalytics extends javax.swing.JFrame {
    ...
    private final I_StudentRepository studentRepository = new StudentRepository(LocalConnector.getLocalConnection());
...
//Agregamos nuestro grafico a una nueva ventana
    ...
    //=============================================
      ...
      public int cantidadValores(int columnaTabla) {
        ...
        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {

                cantidad = jTableListaStudents.getRowCount();
    ...
    public int maximaValores(int columnaTabla) {
        ...
        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {
                ...
                max = Math.round(max(max, Integer.parseInt(jTableListaStudents.getValueAt(i, columnaTabla).toString())));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public float maximaValoresSueldoDecimal(int columnaTabla) {
        ...
        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {
                ...
                max = Math.round(max(max, Float.parseFloat(jTableListaStudents.getValueAt(i, columnaTabla).toString())));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//---------------------------------------------------------------------------------
    public int minimaValores(int columnaTabla) {
        ...
        int min = Integer.parseInt(jTableListaStudents.getValueAt(0, columnaTabla).toString());

        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {

                // min = Math.round(min(min, Integer.parseInt(jTableListaEmpleados.getValueAt(i, columnaTabla).toString())));
                min = Math.round(min(min, Integer.parseInt(jTableListaStudents.getValueAt(i, columnaTabla).toString())));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
...
//---------------------------------------------------------------------------------
     ...
     public float minimaValoresSueldoDecimal(int columnaTabla) {
        ...
        float min = Float.parseFloat(jTableListaStudents.getValueAt(0, columnaTabla).toString());

        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {

                // min = Math.round(min(min, Integer.parseInt(jTableListaEmpleados.getValueAt(i, columnaTabla).toString())));
                min = Math.round(min(min, Float.parseFloat(jTableListaStudents.getValueAt(i, columnaTabla).toString())));
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public int promedioValores(int columnaTabla) {
        ...
        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {
                ...
                sum += Integer.parseInt(jTableListaStudents.getValueAt(i, columnaTabla).toString());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
        promedio = sum / jTableListaStudents.getRowCount();
        return promedio;
    ...
    public float promedioValoresSueldoDecimal(int columnaTabla) {
        ...
        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {
                ...
                sum += Float.parseFloat(jTableListaStudents.getValueAt(i, columnaTabla).toString());
            }
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    public List<String> modaFrecuenciaValores(int columnaTabla) {
        ...
        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {
                ...
                valores = Integer.valueOf(jTableListaStudents.getValueAt(i, columnaTabla).toString());
     ...
     public List<String> modaFrecuenciaValoresSueldoDecimal(int columnaTabla) {
        ...
        try {
            for (int i = 0; i < jTableListaStudents.getRowCount(); i++) {
                ...
                valores = Float.valueOf(jTableListaStudents.getValueAt(i, columnaTabla).toString());
...
//---------------------------------------------------------------------------------
    ...
    public double varianzaValores(int columnaTabla, int columnaTablaPromedioValores) {
        ...
        try {
            ...
            for (int j = 0; j < jTableListaStudents.getRowCount(); j++) {
                double rango;
...
//---------------------------------------------------------------------------------
    ...
    private void initComponents() {
        ...
        jLabelTitulo.setText("ANALYTICS-STUDENTS");
