...
public class JFrameVerStudent extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldBusquedaStudents.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                jTextFieldBusquedaStudentActionPerformed(evt);
            }
        });
        jTextFieldBusquedaStudents.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyReleased(java.awt.event.KeyEvent evt) {
                jTextFieldBusquedaStudentKeyReleased(evt);
            }
        });
    ...
    private void jButtonEliminarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonEliminarActionPerformed
        ...
        int filaTablaSTudents = jTableListaStudents.getSelectedRow();

        if (filaTablaSTudents == -1) {
        ...
        int idStudents = (int) jTableListaStudents.getValueAt(filaTablaSTudents, 0);

        if (JOptionPane.showConfirmDialog(this, "ESTA POR ELIMINAR EL ESTUDIANTE CON EL ID " + idStudents + "!!") != 0) {

            return;

        }

        studentRepository.remove(studentRepository.getById(idStudents));
    ...
    private void jTextFieldBusquedaStudentActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jTextFieldBusquedaEmpleadosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_jTextFieldBusquedaEmpleadosActionPerformed

    private void jTextFieldBusquedaStudentKeyReleased(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_jTextFieldBusquedaEmpleadosKeyReleased
