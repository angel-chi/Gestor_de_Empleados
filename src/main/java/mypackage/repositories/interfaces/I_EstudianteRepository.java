...
public interface I_EstudianteRepository {
    ...
    default List<Estudiante> getByCantidadHsSemanales(int hs_de_clase) {
     ...
     default List<Estudiante> getLikeCantidadHsSemanales(String hs_de_clase) {
        ...
        return getStream()
                .filter(objeto -> String.valueOf(objeto.getHs_de_clase())
                .contains(hs_de_clase))
                .collect(Collectors.toList());
    }
    ...
    default List<Estudiante> getBycalificacion(float calificacion) {
        ...
        return getStream()
                .filter(objeto -> objeto.getCalificacion() == calificacion)
                .collect(Collectors.toList());
    }
        ...
        return getStream()
                .filter(objeto -> String.valueOf(objeto.getCalificacion())
