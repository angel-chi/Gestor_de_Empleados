...
public class EstudianteRepository implements I_EstudianteRepository {
    ...
    public void save(Estudiante estudiante) {
        ...
        try ( PreparedStatement consultaPreparada
                = conexionDB.prepareStatement(
                        ...
                        + " numero_documento,correo_electronico,numero_telefono,fecha_inscripcion,cantidad_clases_semanales,promedio)"
                    ...
                    consultaPreparada.setString(10, estudiante.getFecha_inscripcion());
                    consultaPreparada.setInt(11, estudiante.getCantidad_clases_semanales());
                    consultaPreparada.setFloat(12, estudiante.getPromedio());
    ...
    public void update(Estudiante estudiante) {
        ...
        try ( PreparedStatement consultaPreparada = conexionDB
            ...
            consultaPreparada.setString(9, estudiante.getFecha_inscripcion());
            consultaPreparada.setInt(10, estudiante.getCantidad_clases_semanales());
            consultaPreparada.setFloat(11, estudiante.getPromedio());
                ...
                = conexionDB
                    ...
                    while (resultSetEstudiantes.next()) {
                        ...
                        listaEstudiantes.add(new Estudiante(
                                ...
                                resultSetEstudiantes.getString("fecha_inscripcion"),
                                resultSetEstudiantes.getInt("cantidad_clases_semanales"),
                                resultSetEstudiantes.getFloat("promedio")
                        ));
