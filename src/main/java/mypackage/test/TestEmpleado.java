...
public class TestEmpleado {
    ...
    public static void main(String[] args) {
        ...
        empleadoRepository.getLikeNumeroTelefono(1123467895L).forEach(System.out::println);

        
        System.out.println("\n=================Empleado/s  cuya fecha de inicio sea el 2020-09-12 ===============\n");
        empleadoRepository.getLikeFechaInicio(2020).forEach(System.out::println);

        
        System.out.println("\n=================Empleado/s  cuya cantidad de horas semanales sean 48h ===============\n");
        empleadoRepository.getByCantidadHsSemanales(48L).forEach(System.out::println);
